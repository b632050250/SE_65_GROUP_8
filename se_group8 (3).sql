...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2023 at 08:19 PM
...
--
-- Dumping data for table `checkapprove`
--

INSERT INTO `checkapprove` (`checkapproveID`, `postcostID`, `userID`, `checkapproveTime`, `checkapproveStatusID`) VALUES
(1, 2, 2, '2023-04-03 18:04:54.227077', 1),
(2, 2, 6, '2023-04-03 18:04:54.228680', 1),
(3, 2, 4, '2023-04-03 18:04:54.229378', 1),
(4, 2, 1, '2023-04-03 18:04:54.230817', 1),
(5, 2, 5, '2023-04-03 18:04:54.231364', 1);
...
INSERT INTO `dog` (`dogID`, `dogName`, `subdistrictID`, `dogArea`, `dogpictureID`, `dogcolor`) VALUES
(1, 'ดำ', 1, 'หน้าวัด', 1, 'ดำ'),
...
(2, 2, 'Bronze.png', 'Bronze.png', '2023-04-03 18:04:43.780396', NULL, 'ฟฟฟฟ');
...
INSERT INTO `post` (`postID`, `typetagID`, `userID`, `postTime`, `postofgroupID`, `poststatusID`) VALUES
(2, 2, 1, '2023-04-03 18:04:43.775383', 2, 2);
...
(2, 2, 200, '2023-04-03 18:04:43.776902');
...
(2, NULL, NULL, 2, '2023-04-03 18:04:43.762360');
...
CREATE TABLE `poststatus` (
  `poststatusID` int(100) NOT NULL,
  `poststatusName` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'sasicha', 'salabkaew', '0982636676', 'kanun@gmail.com', NULL, '$2y$10$d4HlSzSh/OzrFoI8G54nfezJOX5EDug1uPo8P0YsQ5i5MR2PQHlU.', NULL, '2023-04-03 08:50:29', '2023-04-03 08:50:29', 1, 1),
...
ALTER TABLE `post`
  ...
  ADD KEY `poststatusID` (`poststatusID`);
...
--
ALTER TABLE `checkapprove`
  MODIFY `checkapproveID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `dog`
  MODIFY `dogID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `dogimg`
--
ALTER TABLE `dogimg`
  MODIFY `dogimgID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `dogpicture`
--
ALTER TABLE `dogpicture`
  MODIFY `dogpictureID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `group`
  MODIFY `groupID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `groupofdog`
--
ALTER TABLE `groupofdog`
  MODIFY `groupofdogID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `opendonate`
  MODIFY `opendonateID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `place`
--
ALTER TABLE `place`
  MODIFY `placeID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `postcost`
  MODIFY `postcostID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `postofgroup`
--
ALTER TABLE `postofgroup`
  MODIFY `postofgroupID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `poststatus`
--
ALTER TABLE `poststatus`
  MODIFY `poststatusID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `post`
  ...
  ADD CONSTRAINT `post_ibfk_4` FOREIGN KEY (`poststatusID`) REFERENCES `poststatus` (`poststatusID`) ON DELETE CASCADE ON UPDATE CASCADE;
