...
<div class = "col" style="margin-top:20px;">
      <a href ="{{route('approve.mypost')}} " class="btn btn-primary btn-xs" > การเปิดรับบริจาคของฉัน</a>
</div>
<div class = "col" style="margin-top:20px;">
      <a href ="{{route('approve.donate')}} " class="btn btn-primary btn-xs" > ตรวจสอบการโอน</a>
</div>
