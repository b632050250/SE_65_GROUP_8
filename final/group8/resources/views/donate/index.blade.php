  ...
  <div class="row align-items-center"  style="margin-top:150px;">
    <div class="col justify-content-center">
      ...
      <div class="card shadow text-center">
        ...
        <h3>{{$per}}%</h3> 
        <h4>{{$am}} from {{$amount}}</h4> 
        <label> <br>ยอดที่ต้องการ {{$amount}} บาท ยอดบริจาคที่ได้รับการอนุมัติ {{$am}} บาท {{$per}}%<br>รอการอนุมัติ  {{$allamount}} บาท </label>
      </div>
    </div>
        <div class ="col d-flex justify-content-center">
          <form  method="POST" action="{{ route('donate.cost') }}" enctype="multipart/form-data">
          @csrf
          <input type="hidden" name="opendonateID" value="2">
        ...
        <div class ="col ">
        <div class="row">
        <img src=" {{ asset('images/user/1.jpg') }}"style="width:100%"  > 
        </div>
