...
<div class="bg-blue rounded text p-5 shadow-down"  >
      ...
      <div class="col-10">
        ...
        <div class="col">
        <a  class="btn btn-warning btn-xs pull-left" href="{{route('approve.donatehistory')}}">History</a>
        </div>
    </div>
  ...
  <div class="row" style="margin-top:20px;">
          ...
          @csrf
        <button type="submit" name="id" value="{{$donate->donationID}}" class="btn btn-danger btn-xs" >การยืนยัน</button>
        </form>
