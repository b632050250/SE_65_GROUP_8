...
<div class="container" style="margin-top:1000px;" >
  ...
  <div class="row"> 
    <div class="col">
       Profile<br>
      <img src=" {{ asset('images/user/1.jpg') }}" alt="portfolio-image" class="img-fluid rounded w-100" width="500" height="600"> 
      </div>
...
<div class = "row" style="margin-top:20px;">
      <a href ="{{route('approve.post')}} " class="btn btn-primary btn-xs" > การอนุมัติของฉัน</a>
</div>
<div class = "row" style="margin-top:20px;">
      <a href ="{{route('approve.mypost')}} " class="btn btn-primary btn-xs" > การเปิดรับบริาคของฉัน</a>
</div>
<div class = "row" style="margin-top:20px;">
      <a href ="{{route('approve.donate')}} " class="btn btn-primary btn-xs" > ตรวสอบการโอน</a>
</div>
      </div>
</div>
