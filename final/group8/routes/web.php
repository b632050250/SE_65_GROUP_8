...
//earn
Route::get('/province', [DropdownController::class, 'view'])->name('province');
...
//kanun
Route::get('dropdown', [DropdownController::class, 'view1'])->name('dropdownView');
...
//jiji
Route::get('/donate/index/{id}',[App\Http\Controllers\DonateController::class, 'index'])->name('donate.food') ;
...
//tong
Route::get('/about',[ViewGroupController::class,'index']);
